...
var verifyListingInput = function (_a) {
...
exports.listingResolvers = {
    Query: {
        ...
        listings: function (_root, _a, _b) {
            var filter = _a.filter, limit = _a.limit, page = _a.page, location = _a.location;
            var db = _b.db;
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_f) {
                    switch (_f.label) {
                        ...
                        case 6:
                            error_2 = _f.sent();
                            throw new Error("failed to query user listings: " + error_2);
                    ...
                    switch (_d.label) {
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, db.listings.insertOne(__assign(__assign({ _id: new mongodb_1.ObjectId() }, input), { image: imageUrl, bookings: [], bookingsIndex: {}, country: country,
                                    admin: admin,
                                    city: city, host: viewer._id, authorized: false }))];
                        case 4:
    ...
    Listing: {
        bookingsIndex: function (listing) { return JSON.stringify(listing.bookingsIndex); },
        id: function (listing) {
